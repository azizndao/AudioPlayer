...
private val ACCENT_THEMES =
    intArrayOf(
        ...
        R.style.Theme_App_Pink,
        R.style.Theme_App_Purple,
        R.style.Theme_App_DeepPurple,
        R.style.Theme_App_Indigo,
        R.style.Theme_App_Blue,
        R.style.Theme_App_DeepBlue,
        R.style.Theme_App_Cyan,
        R.style.Theme_App_Teal,
        R.style.Theme_App_Green,
        R.style.Theme_App_DeepGreen,
        R.style.Theme_App_Lime,
        R.style.Theme_App_Yellow,
        R.style.Theme_App_Orange,
        R.style.Theme_App_Brown,
        R.style.Theme_App_Grey,
        R.style.Theme_App_App // Dynamic colors are on the base theme
        )

private val ACCENT_BLACK_THEMES =
    intArrayOf(
        R.style.Theme_App_Black_Red,
        R.style.Theme_App_Black_Pink,
        R.style.Theme_App_Black_Purple,
        R.style.Theme_App_Black_DeepPurple,
        R.style.Theme_App_Black_Indigo,
        R.style.Theme_App_Black_Blue,
        R.style.Theme_App_Black_DeepBlue,
        R.style.Theme_App_Black_Cyan,
        R.style.Theme_App_Black_Teal,
        R.style.Theme_App_Black_Green,
        R.style.Theme_App_Black_DeepGreen,
        R.style.Theme_App_Black_Lime,
        R.style.Theme_App_Black_Yellow,
        R.style.Theme_App_Black_Orange,
        R.style.Theme_App_Black_Brown,
        R.style.Theme_App_Black_Grey,
        R.style.Theme_App_Black // Dynamic colors are on the base theme
        )
